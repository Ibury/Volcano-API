...
map_fields_model = api.model('MapField', {
    #'type_map': fields.String(readOnly=True, description='Type of the target map'),
    #'name': fields.String(required=True, description='The name field')
    'map': fields.String(readOnly=True)
})
...
target = api.model('Target', {
    'volcan': volcano_fields['json_file'],
    'map': volcano_fields['file']
})
...
event_tree_metadata_model = api.model('EventTreeMetadata', {
    ...
    'Volcano ID': fields.String(description='Volcano ID'),
    'Volcano Lat': fields.String(description='Latitude of the volcano'),
    'Volcano Long': fields.String(description='Longitude of the volcano'),
    'Grid- Ll grid point (product reference system)': fields.String(
    ...
    'Tif File aux': fields.String(description='URL for accessing the map aux tif file'),
    'Tif File': fields.String(description='URL for accessing the map'),
    'Png file': fields.String(description='URL for accessing the map png'),
